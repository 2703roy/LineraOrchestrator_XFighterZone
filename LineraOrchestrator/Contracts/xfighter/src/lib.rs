...
pub struct MatchResult {
	...
	pub player1_userchain: String,
    pub player2_userchain: String,
	pub player1_heroname: String,
    pub player2_heroname: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub enum XfighterMessage {
    RecordScore(RecordScoreMessage),
